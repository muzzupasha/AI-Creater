    ...
    <div className="min-h-screen bg-black text-white overflow-hidden relative">
        ...
        <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
          ...
          <div>
            <Image
              ...
              width={500}
              height={700}
              className="w-full h-auto object-contain bg-transparent bg-none"
            />
          </div>
        </div>
      </section>
            ...
            {socialProofStats.map((stat, index) => (
              <div key={index} className="text-center">
                ...
                <span className="flex items-baseline justify-center">
                  <CountingNumber
                    number={stat.metric}
                    className="text-3xl sm:text-4xl lg:text-5xl font-black mb-2 gradient-text-accent"
                    decimals={stat.label === "Uptime" ? 1 : 0}
                    duration={2}
                    separator="," // for thousands
                  />
                  {stat.suffix && (
                    <span className="ml-1 text-lg font-bold text-purple-300">{stat.suffix}</span>
                  )}
                </span>
      ...
      <section className="relative z-10 py-16 sm:py-24 px-4 sm:px-6 bg-gradient-to-r from-gray-900/50 to-purple-900/20">      
           <div className="flex flex-col items-center justify-center h-100  "> 
            <h2 className="text-9xl sm:text-10xl md:text-6xl font-black mb-6 sm:mb-8">   
      <TypewriterEffectSmooth words={words} /></h2>  
