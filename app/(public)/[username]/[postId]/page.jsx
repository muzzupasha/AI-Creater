...
import { Badge, Calendar, Eye, Heart, Loader2, MessageCircle, Send, Trash2 } from 'lucide-react';
...
const PostPage = ({ params }) => {
  ...
  // Fetch current Convex user data
               ...
               <div className="flex items-center space-x-3 hover:opacity-80 transition-opacity">
                  <div className="relative w-12 h-12">
                    {post.author.imageUrl ? (
                      ...
                      <div className="w-full h-full rounded-full bg-gradient-to-br from-purple-600 to-blue-600 flex items-center justify-center text-lg font-bold mt-20">
              ...
              <div className="flex flex-wrap gap-2">
                {post.tags.map((tag) => (
                  <span
                    key={tag}
                    variant="secondary"
                    className="bg-purple-500/20 text-purple-300 border-purple-500/30 rounded-sm text-md"
                  >
                    {tag}
                  </span>
                ))}
