  ...
  return (
    <div className="min-h-screen bg-slate-900 text-white">
      ...
      <div className="ml-0 lg:ml-64">
        {/* Top Header */}
        <header
          className="fixed w-full top-0 right-0 z-30 bg-slate-800/80 backdrop-blur-sm border-b border-slate-700 h-[65px]"
          ...
          <div className="flex items-center justify-between px-4 lg:px-8 py-4">
            ...
            <div className="flex items-center space-x-4">
              ...
              <UserButton
                appearance={{
                  elements: {
                    avatarBox: "w-8 h-8 rounded-lg border border-slate-600 mt-3",
