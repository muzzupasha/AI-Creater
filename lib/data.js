...
export const socialProofStats = [
  { metric: 5000, label: "Active Creators", icon: Users, suffix: "+" },
  { metric: 20000, label: "Published Posts", icon: PenTool, suffix: "+" },
  { metric: 100000, label: "Monthly Readers", icon: Eye, suffix: "+" },
  { metric: 99.9, label: "Uptime", icon: Shield, suffix: "%" },
];
