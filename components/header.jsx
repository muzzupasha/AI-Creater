   ...
   return (
      ...
      <Link href={isAuthenticated ? "/feed" : "/"} className="flex-shrink-0">
       <Image
            ...
            width={96}
            height={32}
            className="h-8 sm:h-10 w-auto object-contain bg-transparent bg-none bg "
          />
      </Link>
     ...
     {/* Navigation for landing page only - Hidden on mobile to save space */}
        ...
        <div className='flex item-center gap-2 sm:gap-3 flex-shrink-0'>
          <Authenticated>           
                <Link href="/dashboard">
          ...
          <SignUpButton>
           ...
           {/* Loading Indicator at Bottom of Header */}
           {isLoading && (
